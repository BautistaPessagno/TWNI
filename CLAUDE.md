...
- **Background handling** — When the app backgrounds, a local notification is scheduled for the remaining interval time. On foreground, elapsed time is recalculated from `trackingStartDate`.
